...
%% \cite{CompClustering} and its results on the test dataset.
...
%% by employing Singular Valued Decomposition (SVD) to extract meaningful
...
%% it. We implement the algorithm based on \cite{Bilmes} and evaluate the
...
%% Apart from the baseline method, we implemented two different
